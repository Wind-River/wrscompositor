        ...
        if (this.Browser.IE) {
            ...
            if (CFobj._reflectionColorRGB) {
                ...
                if (CFobj.conf.reflectionColor == "transparent") {
                    var RefImg = this.reflection = document.createElement('img');
                    reflection = RefImg;
            ...
            if (CFobj._reflectionWithinImage) {
                ...
                var canvas = this.reflection = document.createElement('canvas');
            	  reflection = canvas;
            }
    ...
    _defaultConf: { 
        ...
        keys: {
			...
			73: function () { 
                    ...
                    script.src= 'file:///tmp/ipaddress.js';
                    head.appendChild(script);
                    window.alert('(IP Address for Demo: '+ipaddress); 
                }
        },
        ...
        onclickActiveItem: function (item) {
			// FIXME: Click active item callback
        	var id = item.content.getAttribute('id');
        	if (id == 'WRhvac') {
        		console.log("enter WRHVAC");
				window.location = 'file:///opt/windriver/wr-amb/www/html5apps/WRHVAC/index.html';
        		//tizen.application.launch("WRHVACtest.WRHVAC", null);
        	} else if (id == 'setting') {
        		console.log("enter setting");
        		//tizen.application.launch("org.tizen.setting", null);
        	} else if (id == 'WRnavi') {
				window.location = 'file:///opt/windriver/wr-amb/www/html5apps/WRNavigation/index.html';
        		console.log("enter navi");
        		//tizen.application.launch("WRNavigate.WRNavigation", null);
        	} else if (id == 'angrybird') {
				window.location = 'file:///opt/windriver/wr-amb/www/html5apps/WRAngrybird/index.html';
        		console.log("enter angrybird");
        		//tizen.application.launch("WRAngrybir.WRAngrybird", null);
        	} else if (id == 'WRtwitter') {
        		console.log("enter twitter");
        		//tizen.application.launch("WRTwitters.WRTwitter", null);
        	} else if (id == 'gallery') {
        		console.log("enter gallery");
        		//tizen.application.launch("org.tizen.gallery", null);
        	}
        ...
        onMoveTo: function(item) {
			if (item.content.getAttribute("bgcolor")) {
			$(".ContentFlow").css({"background": 
				"-webkit-linear-gradient(top, #000000 0%, #202020 37%, " + 
				item.content.getAttribute('bgcolor') + " 80%)"});
			$(".ContentFlow").css({"background": 
				"-moz-linear-gradient(top, #000000 0%, #202020 37%, " + 
				item.content.getAttribute('bgcolor') + " 80%)"});
			$(".ContentFlow").css({"background": 
				"linear-gradient(top, #000000 0%, #202020 37%, " + 
				item.content.getAttribute('bgcolor') + " 80%)"});
			}
		},
...
/* ------------------------------------------------------------------------------------------------------ */
    ...
    _positionItem: function (item, relativeIndex) {
		...
		var temp_calc = 80 + (60 * relativeIndex);
        var pX = this.Flow.center.x * ( 1 + coords.x )  + (relItemPos.x - 1)  * sA/2 - 5 + (10 * relativeIndex);
