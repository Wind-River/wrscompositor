...
#ifndef _WAYLANDFBDEVGLESRENDERER_H_
#define _WAYLANDFBDEVGLESRENDERER_H_
...
{
public:
    WaylandFbdevGLESRenderer(ICommandExecutor& executor, Configuration& config);
...
#endif /* _WAYLANDFBDEVGLESRENDERER_H_*/
